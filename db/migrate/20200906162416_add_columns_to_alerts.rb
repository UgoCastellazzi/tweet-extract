class AddColumnsToAlerts < ActiveRecord::Migration[6.0]
  def change
    ...
    add_column :alerts, :keywords_excluded, :string, array: true, default: []
    add_column :alerts, :hashtags, :string, array: true, default: []
    add_column :alerts, :language, :string
    add_column :alerts, :mentionned_accounts, :string, array: true, default: []
